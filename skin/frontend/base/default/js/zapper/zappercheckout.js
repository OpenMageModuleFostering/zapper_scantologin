...
//VERSION: 1.1.80 BETA 1

var ZapperTechCheckout = (function($) {
    var ZapperTechCheckout = ZapperTechCheckout || {};

    ZapperTechCheckout.QrCode = function(options, callback) {
        this.context = {};
        this.defaults = {
    ...
    ZapperTechCheckout.QrCode.prototype.init = function(settings, callback) {
    ...
    ZapperTechCheckout.QrCode.prototype.scanComplete = function(requestTypeSet, callback) {
    ...
    ZapperTechCheckout.QrCode.prototype.registrationRequest = function(callback) {
    ...
    ZapperTechCheckout.QrCode.prototype.loginRequest = function(callback) {
        this.context.pollRequestTypeSet.push(this.CONSTANTS.REQUESTTYPE.loginRequest);
        this.context.loginRequest = callback || function() {
        };
    };

    ZapperTechCheckout.QrCode.prototype.paymentRequest = function(callback) {
    ...
    ZapperTechCheckout.QrCode.prototype.poll = function() {
    ...
    ZapperTechCheckout.QrCode.prototype.getAnswer = function (answers, questionId) {
        var code = this;
    ...
    ZapperTechCheckout.QrCode.prototype.sessionId = function() {
        return this.context.sessionId;
    };

    ZapperTechCheckout.QrCode.prototype.pollHandle = function(responseSet, status) {
        var code = this;
        if (status === "success") {
    ...
    ZapperTechCheckout.QrCode.prototype.respond = function(type, data, afterRespondHandler) {
    ...
    ZapperTechCheckout.QrCode.prototype.registrationRespond = function(data, afterRespondHandler) {
        this.respond(this.CONSTANTS.REQUESTTYPE.registrationResponse, data, afterRespondHandler);
    };

    ZapperTechCheckout.QrCode.prototype.loginRespond = function(data, afterRespondHandler) {
        this.respond(this.CONSTANTS.REQUESTTYPE.loginResponse, data, afterRespondHandler);
    };

    ZapperTechCheckout.QrCode.prototype.start = function() {
        this.poll();
    };

    ZapperTechCheckout.QrCode.prototype.stop = function() {
